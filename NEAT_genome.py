...
toggle_chance = 0.05
split_conn_chance = 0.01
add_conn_chance = 0.05
weight_mutation_chance = 0.2
weight_perturbation_chance = 0.8
    ...
    def mutate(self):
        ...
        while idx < l:
            ...
            #fourth check for weight mutation or perturbation 
                ...
                conn.weight += random.uniform(-0.01, 0.01)
            self.network = NN.Network(self)
            idx += 1
