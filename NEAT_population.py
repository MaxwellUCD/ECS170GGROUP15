...
class Population:
    ...
    def speciate(self):
       ...
       #     print(compatability_threshold)
        if len(self.species) < 5 and count > 25:
            compatability_threshold -= 0.1
            count = 0
            print(compatability_threshold)
        else:
    ...
    def evolve(self, iterations):
        for i in range(iterations):
            ...
            for s in self.species:
                ...
                print(str((len(s.members), (round(avg_size_n), round(avg_size_c)), round(best_genome.fitness, 3), s.stagnation, round(best_fitness - self.avg_fitness, 3))) + ", ",end="")
